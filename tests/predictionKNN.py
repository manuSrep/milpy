...
from milpy import BayesianKNN
from milpy import CitationKNN
...
if __name__ == "__main__":
    ...
    if MUSK1:
        ...
        print(cross_val_score(estimator,musk1,scoring=scorere,cv=cv, n_jobs=-1 ))